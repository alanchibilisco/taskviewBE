...
import { validateEmail, validateTexto, validateTelefono } from "../helpers/Validaciones";
...
pacienteCtrl.postPaciente = async (req, res) => {
  ...
  try {
    ...
    if (validateTexto(req.body.nombreDueño)&&validateTexto(req.body.apellidoDueño)&&validateEmail(req.body.email)&&validateTelefono(req.body.telefono)&&validateTexto(req.body.nombreMascota)&&validateTexto(req.body.especieMascota)&&validateTexto(req.body.razaMascota)){
